...
test <- list(
  c(
    22.55386229, 7.34369854, 13.67618618, 0.06114788, 5.27577624,
...
# test for day_1
day_1 <- extract_observations(t, day = 1)
day1 <- list(data.frame(day_1)[, 6])
...
# test for day_2
day_2 <- extract_observations(t, day = 2)
day2 <- list(data.frame(day_2)[, 6])
...
# test for day_3
day_3 <- extract_observations(t, day = 3)
day3 <- list(data.frame(day_3)[, 6])
