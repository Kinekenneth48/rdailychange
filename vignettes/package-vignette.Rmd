...
df = distinct(clean_dataset, ID, .keep_all = TRUE) %>%
...
d1 = rdailychange::extract_observations(clean_dataset, day=1)
d1[[1]][[1]]


# extract Day-2 observations
d2 = rdailychange::extract_observations(clean_dataset, day=2)
d2[[1]][[1]]


# extract Day-3 observations
d3 = rdailychange::extract_observations(clean_dataset, day=3)
d3[[1]][[1]]
```
